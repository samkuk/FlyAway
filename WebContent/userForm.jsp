			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Airlines Name</label> <input type="text"
						value="<c:out value='${user.airlineName}' />" class="form-control"
						name="airlineName" required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Source City</label> <input type="text"
						value="<c:out value='${user.sourceCity}' />" class="form-control"
						name="sourceCity">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Destination City</label> <input type="text"
						value="<c:out value='${user.destinationCity}' />" class="form-control"
						name="destinationCity" required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Travel Date</label> <input type="text"
						value="<c:out value='${user.travelDate}' />" class="form-control"
						name="travelDate">
				</fieldset>

				<fieldset class="form-group">
					<label>Departure Time</label> <input type="text"
						value="<c:out value='${user.departureTime}' />" class="form-control"
						name="departureTime">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Arrival Time</label> <input type="text"
						value="<c:out value='${user.arrivalTime}' />" class="form-control"
				...
				<fieldset class="form-group">
					<label>Available Seats</label> <input type="text"
						value="<c:out value='${user.avilableSeats}' />" class="form-control"
						name="avilableSeats" required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Class</label> <input type="text"
						value="<c:out value='${user.clas}' />" class="form-control"
						name="clas">
				</fieldset>
